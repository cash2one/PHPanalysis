 ...
 * 返回：守关排行：排名，角色名，章节，第几波，等级，帮派，门派，vip等级
 *     {rank, role_name, chapter, count, level, family_name, category, vip_grade}
 * 
 */
...
$sql = "SELECT rank, role_name, chapter, count, level, family_name, category, vip_grade FROM t_ranking_defend " .
