 ...
 * 返回：申请发放元宝者，申请时间，玩家角色名，玩家账号，元宝数量，是否绑定(1->绑定，0->不绑定)，发放理由，审核人，审核发放时间
 * 	   {apply_admin_name, apply_time， role_name, account_name, gold_num, bind, reason, review_admin_name, review_time}
 */
...
$sql = "SELECT r.admin_name as apply_admin_name, from_unixtime(r.mtime) as apply_time, r.user_name as role_name," .
		" b.account_name, r.number as gold_num, r.bind, r.reason, r.review_admin_name, from_unixtime(r.review_mtime) as review_time" .
		...
		" AND r.item_name='send_gold' AND r.status='4' ORDER BY r.id ASC";
