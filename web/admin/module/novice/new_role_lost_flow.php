...
$sql='SELECT guide.uid,guide.condition_guide_ids,player.nick FROM guide,player WHERE  guide.uid=player.id AND '.$end_time.' - player.last_login_time > 129600 AND player.logout_time BETWEEN '.$begin_time.' AND '.$end_time.' AND player.logout_time - player.reg_time < 86400';
...
$smarty->assign($data);
$smarty->display("module/novice/new_role_lost_flow.html");
?>
