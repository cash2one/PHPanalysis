...
$sql='SELECT guide.uid,guide.condition_guide_ids,player.nick FROM guide,player WHERE guide.uid=player.id AND '.$end_time.' - player.last_login_time > 129600';
...
$smarty->assign($data);
$smarty->display("module/novice/role_lost_flow.html");
?>
