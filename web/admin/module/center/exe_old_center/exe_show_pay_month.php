...
$sql = 'SELECT id , round(sum( pay_day ),2) as sum_pay_day , round(sum( role_cnt ),0) as sum_role_cnt , round(sum( times_cnt ),0) as sum_times_cnt , ' .
...
$smarty->display("module/center/exe_show_pay_month.html");
