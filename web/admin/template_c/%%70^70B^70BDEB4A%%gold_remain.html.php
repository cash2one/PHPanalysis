<?php /* Smarty version 2.6.25, created on 2016-05-21 11:25:11
         compiled from module/pay/gold_remain.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'module/pay/gold_remain.html', 80, false),)), $this); ?>
...
<title>
	<?php echo $this->_tpl_vars['_lang']['left']['last_silver_ingot']; ?>
...
?>
	...
	<tr class='table_list_head'>
		...
		<td><?php echo $this->_tpl_vars['_lang']['new']['remain_bind_gold']; ?>
</td>
		<td><?php echo $this->_tpl_vars['_lang']['left']['surplus']; ?>
<?php echo $this->_tpl_vars['_lang']['conmon']['ingot']; ?>
</td>
		<!--<td><?php echo $this->_tpl_vars['_lang']['new']['remain_all_gold']; ?>
</td>-->
	...
	<?php endif; ?>
		<td>
		<?php echo $this->_tpl_vars['keywordlist'][$this->_sections['loop']['index']]['id']; ?>
		...
		<td><?php echo $this->_tpl_vars['keywordlist'][$this->_sections['loop']['index']]['gold_bind']; ?>
</td>
		<td><?php echo $this->_tpl_vars['keywordlist'][$this->_sections['loop']['index']]['gold']; ?>
</td>
		<!--<td><?php echo $this->_tpl_vars['keywordlist'][$this->_sections['loop']['index']]['gold_sum']; ?>
</td>-->
