<?php /* Smarty version 2.6.25, created on 2016-05-21 14:56:00
         compiled from module/pay/send_silver.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'module/pay/send_silver.html', 111, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $this->_tpl_vars['_lang']['left']['apply_silver']; ?>
</title>
...
<ul id="ulSendGoldReason">
		...
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note1']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note2']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note3']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note4']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note5']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note6']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note7']; ?>
</a></li>
		<li class="reasonItem"><a href="javascript:void(0);"><?php echo $this->_tpl_vars['_lang']['new']['apply_silver_note8']; ?>
</a></li>
</ul>
...
：<?php echo $this->_tpl_vars['_lang']['left']['apply_silver']; ?>
</div>
...
?action=send_silver&role_id=<?php echo $this->_tpl_vars['role']['role_id']; ?>
...
2:</b></font>
		...
		<table width="800"  border="1" cellpadding="4" cellspacing="1" bgcolor="#A5D0F1">
			<tr bgcolor="#E5F9FF">
               <td colspan="2" background="/web/admin/static/images/wbg.gif" align="left">
                  <font color="#666600" class="STYLE2"><b>::<?php echo $this->_tpl_vars['_lang']['left']['giving_silver']; ?>
</b></font>
               </td>
            </tr>
            <tr bgcolor="#FFFFFF">
